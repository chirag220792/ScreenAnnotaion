...
namespace ScreenAnnotation.IOS.TouchTracking
{
    internal class TouchRecognizer : UIGestureRecognizer
    {
        ...
        private readonly ScreenAnnotation.TouchTracking.TouchEffect touchEffect;
        ...
        public TouchRecognizer(Element element, UIView view, ScreenAnnotation.TouchTracking.TouchEffect touchEffect)
        {
